...
image: /assets/images/blog/2024-07-14/location2stix.png
featured_image: /assets/images/blog/2024-07-14/location2stix.png
layout: post
published: true
redirect_from:
  - 
...
If you're unsure of the difference between SDOs and SCOs, [please read this post first](https://www.dogesec.com/blog/beginners_guide_stix_objects).
...
Of course, [I could create some custom SDOs](https://www.dogesec.com/blog/create_custom_stix_objects). The problem with this approach is interoperability. Many downstream products will not understand custom STIX objects out-of-the-box.
...
<iframe width="768" height="432" src="https://miro.com/app/live-embed/uXjVKAj06DQ=/?moveToViewport=-872,-420,1198,638&embedId=55986494168" frameborder="0" scrolling="no" allow="fullscreen; clipboard-read; clipboard-write" allowfullscreen></iframe>
...
Once [location2stix](https://github.com/muchdogesec/location2stix) has generated the STIX object, [which you can also download here](https://raw.githubusercontent.com/muchdogesec/location2stix/main/output/locations-bundle.json), you can use [stix2arango](https://github.com/muchdogesec/stix2arango/) to store them into a graph database for querying and retrieval as needed.

Here is an example stix2arango command to import the locations bundle (make sure to replace `path/to/locations-bundle.json` with the correct path);
...
For example, if I was an intelligence producer who wanted to use the STIX 2.1 objects for North Korea, and I know the two digit ISO code (`KP`), I could find it using the query...
...
I know there are many changes that can be made to improve the objects and structure, and I welcome feedback in [locations2stix](https://github.com/muchdogesec/location2stix/).
